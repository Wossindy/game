...
namespace game
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            bg1.MouseMove += MoseClickMove;

            bg2.MouseDown += MouseClickDown;
            bg2.MouseUp += MouseClickUp;
            bg2.MouseMove += MoseClickMove;
        ...
        private void MoseClickMove(object sender, MouseEventArgs e)
        {
            if(dragging)
            {
                Point currPoint = PointToScreen(new Point(e.X, e.Y));
                this.Location = new Point(currPoint.X - pos.X + bg1.Top);
            }
        }
